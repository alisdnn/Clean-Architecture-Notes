...
import com.example.cleannotes.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_PENDING
import com.example.cleannotes.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_SUCCESS
import com.example.cleannotes.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_ARE_YOU_SURE
import com.example.cleannotes.business.domain.state.*
import com.example.cleannotes.business.domain.util.DateUtil
import com.example.cleannotes.framework.datasource.cache.database.NOTE_FILTER_DATE_CREATED
import com.example.cleannotes.framework.datasource.cache.database.NOTE_FILTER_TITLE
import com.example.cleannotes.framework.datasource.cache.database.NOTE_ORDER_ASC
import com.example.cleannotes.framework.datasource.cache.database.NOTE_ORDER_DESC
import com.example.cleannotes.framework.presentation.common.BaseNoteFragment
import com.example.cleannotes.framework.presentation.common.TopSpacingItemDecoration
import com.example.cleannotes.framework.presentation.common.hideKeyboard
import com.example.cleannotes.framework.presentation.notedetail.NOTE_DETAIL_SELECTED_NOTE_BUNDLE_KEY
import com.example.cleannotes.framework.presentation.notelist.state.*
import com.example.cleannotes.framework.presentation.notelist.state.NoteListStateEvent.*
import com.example.cleannotes.framework.presentation.notelist.state.NoteListToolbarState.*
...
const val NOTE_LIST_STATE_BUNDLE_KEY = "com.example.cleannotes.notes.framework.presentation.notelist.state"
    ...
    private fun setupFAB(){
        add_new_note_fab.setOnClickListener {
            uiController.displayInputCaptureDialog(
                getString(com.example.cleannotes.R.string.text_enter_a_title),
